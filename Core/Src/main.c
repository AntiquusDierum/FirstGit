...
//        HAL_UART_Transmit(debug_uart, &eric_uart_rx, 1, HAL_MAX_DELAY);
...
//  SHT2x_SetResolution(RES_14_12);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if (redraw_command_screen != old_redraw)
	  {
	      char dbg[32];

	      sprintf(dbg,
	              "redraw=%u\r\n",
	              redraw_command_screen);
	      ...
	      old_redraw = redraw_command_screen;
	  }
